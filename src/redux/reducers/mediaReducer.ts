import {
  GET_MEDIA,GET_MEDIA_SUCCESS,GET_MEDIA_FAILURE,
  UPLOAD_MEDIA,UPLOAD_MEDIA_SUCCESS,UPLOAD_MEDIA_FAILURE,
  DELETE_MEDIA,DELETE_MEDIA_SUCCESS,DELETE_MEDIA_FAILURE,
