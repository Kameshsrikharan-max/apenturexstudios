import {GET_EVENTS,GET_EVENTS_SUCCESS,GET_EVENTS_FAILURE,CREATE_EVENT,CREATE_EVENT_SUCCESS,CREATE_EVENT_FAILURE,
  UPDATE_ATTENDANCE,UPDATE_ATTENDANCE_SUCCESS,UPDATE_ATTENDANCE_FAILURE,UPDATE_PAYMENT,UPDATE_PAYMENT_SUCCESS,UPDATE_PAYMENT_FAILURE,ASSIGN_TEAM,ASSIGN_TEAM_SUCCESS,ASSIGN_TEAM_FAILURE,UPLOAD_EVENT_MEDIA,UPLOAD_EVENT_MEDIA_SUCCESS,UPLOAD_EVENT_MEDIA_FAILURE,CLOSE_EVENT,CLOSE_EVENT_SUCCESS,CLOSE_EVENT_FAILURE,} from "../types/eventTypes";
